...
def test_ft_exercise(exercise_file_name, choice):
    """
    ...
    try:
        ...
        module_path = f"ex{choice}/{exercise_file_name}.py"
        spec = importlib.util.spec_from_file_location(exercise_file_name, module_path)
        ft_module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(ft_module)
...
def main():
    ...
    if choice == "0":
        test_ft_exercise("ft_hello_garden", choice)
    elif choice == "1":
        test_ft_exercise("ft_plot_area", choice)
    elif choice == "2":
        test_ft_exercise("ft_harvest_total", choice)
    elif choice == "3":
        test_ft_exercise("ft_plant_age", choice)
    elif choice == "4":
        test_ft_exercise("ft_water_reminder", choice)
    elif choice == "5":
        test_ft_exercise("ft_count_harvest_iterative", choice)
        test_ft_exercise("ft_count_harvest_recursive", choice)
    elif choice == "6":
        test_ft_exercise("ft_garden_summary", choice)
    elif choice == "7":
        test_ft_exercise("ft_seed_inventory", choice)
    elif choice == "a":
