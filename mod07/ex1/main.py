...
if __name__ == "__main__":
	...
	print(f"{Colors.CYAN}Building deck with different card types...{Colors.END}\n")
	...
	print(f"\n{Colors.BOLD}{Colors.YELLOW}Drawing and playing cards:{Colors.END}\n")
	while True:
		card = deck.draw_card()
		if card is None:
			break
		...
		print(f"{Colors.BOLD}{Colors.CYAN}Drew: {card.name} ({card_type}){Colors.END}")
	...
	print(f"{Colors.BOLD}{Colors.HEADER}✨ Polymorphism in action: Same interface, different card behaviors!{Colors.END}\n")
